...
const contractData = require('../contracts/contract-data.json')
...
module.exports = {
  ...
  async init()
  {
    ...
    async getTokensBalance( tokenAddress, ownerAddress){
      ...
      console.log( 'getTokensBalance' , tokenAddress)

        let tokenContract = await this.getTokenContract( tokenAddress  )
        let balanceRaw = await tokenContract.methods.balanceOf(ownerAddress).call()
