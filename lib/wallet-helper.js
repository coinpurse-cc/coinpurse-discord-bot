...
*/
  ...
  async generateTippingURL(senderAddress, recipientAddress, amountFormatted){
      let url = `https://coinpurse.cc/#/tip?from=${senderAddress}&to=${recipientAddress}&amt=${amountFormatted}`
