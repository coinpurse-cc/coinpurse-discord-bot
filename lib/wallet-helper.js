...
*/
  ...
  async generateTippingURL(senderAddress, recipientAddress, tokenAddress, amountRaw){
      let url = `https://coinpurse.cc/#/tip?from=${senderAddress}&to=${recipientAddress}&tokenaddress=${tokenAddress}&amount=${amountRaw}`
